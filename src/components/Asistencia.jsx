      ...
      {linkAsistencia && linkAsistencia.trim() !== "" && (
        <div className={`pb-20 pt-10 ${clase}`}>
          <div className="h-full flex flex-col justify-center items-center space-y-2">
            ...
            <p className="text-lg text-gray-700 max-w-2xl mx-auto leading-relaxed mb-6 text-center px-3 pt-4">
            Por favor, confirmar tu asistencia antes del 8 de octubre
          </p>
          </div>
        </div>
      )}
